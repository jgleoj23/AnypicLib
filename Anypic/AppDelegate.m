...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
 ...
 //   [ParseCrashReporting enable];ParseClientConfiguration
//    [Parse setApplicationId:@"panoramaSahre" clientKey:@"+77015678"];
    [Parse initializeWithConfiguration:[ParseClientConfiguration
                    ...
                    configuration.applicationId = @"panoramaShare";
                    configuration.clientKey = @"+1770415678";
                    configuration.server = @"http://panorama-share.herokuapp.com/parse";
                }]];
...
- (void)setupAppearance {
    ...
    [[UIButton appearanceWhenContainedInInstancesOfClasses:@[[UINavigationBar class]]]
